            ...
            <div class="col-xs-12">
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <a href="{{ URL::To('admin/land/create') }}">
                   ...
                   <tbody>
                    <?php $tmp = 0; ?>
                      ...
                      <tr> 
                        ...
                        <td>
                        <a href="{{ URL::To('admin/land/show/'.$land->id) }}">
                          {{ $land->name }} 
                        </a>
                      </td>
                        <td>
                           {{ substr($land->description, 0, 200) }} ...
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/land/delete/'.$land->id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/land/edit/'.$land->id) }}">
