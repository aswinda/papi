          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-solid">
                ...
                <!-- form start -->
                <form class="form" role="form" method="POST" action="{{ url('admin/seed/update/'.$seed->id) }}" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                   <div class="box-body">
                    <div class="form-group">
                      <label>Name</label>
                      <input name="name" type="text" class="form-control" placeholder="{{ $seed->name }}" value="{{ $seed->name }}">
                    </div>
                    <div class="form-group">
                      <label>Stock</label>
                      <input name="stock" type="text" class="form-control" placeholder="{{ $seed->stock }}" value="{{ $seed->stock }}">
                    </div>
                    <div class="form-group">
                      <label>Price</label>
                    ...
                    <div class="form-group">
                      <textarea name="description" id="compose-textarea" class="form-control" style="height: 300px">
                        {!!html_entity_decode($seed->description)!!}
                      </textarea>
                    </div>
                    <div class="box-footer">
                  <ul class="mailbox-attachments clearfix">
                    <li>
                      <span class="mailbox-attachment-icon has-img"><img src="{{ URL::to('images/seeds/'.$seed->path) }}" alt="Attachment"/></span>
                      <div class="mailbox-attachment-info">
                        <a href="#" class="mailbox-attachment-name"><i class="fa fa-camera"></i> {{ $seed->name }}</a>
                    ...
                    <div class="form-group">
                      <div class="btn btn-default btn-file">
                        ...
                        <input name="file" type="file" value="{{ $seed->path }}" />
                      </div> 
