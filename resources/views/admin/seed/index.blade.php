...
@section('content')
            ...
            <div class="col-xs-12">
              <div class="box box-solid">
                <div class="box-header with-border">
                  <a href="{{ URL::To('admin/seed/create') }}">
                   ...
                   <tbody>
                    <?php $tmp = 0; ?>
                      ...
                      <tr> 
                        ...
                        <td>
                        <a href="{{ URL::To('admin/seed/show/'.$seed->id) }}">
                          {{ $seed->name }} 
                        </a>
                      </td>
                        <td>
                           {{ substr($seed->description, 0, 200) }} ...
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/seed/delete/'.$seed->id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/seed/edit/'.$seed->id) }}">
    ...
    <div id="confirm" class="modal fade">
     ...
     <link rel="stylesheet" href="{{ URL::To('plugins/datatables/dataTables.bootstrap.css') }}" type="text/css"/>
    <style>
      .linkButton { 
       background: none;
       border: none;
