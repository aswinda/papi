                   ...
                   <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <select name="group" class="form-control">
                          <option value="0" <?php if($user->group_id == 0) echo 'selected'; ?>>Admin</option>
                          <option value="1" <?php if($user->group_id == 1) echo 'selected'; ?>>Investor</option>
                          <option value="2" <?php if($user->group_id == 2) echo 'selected'; ?>>Land Owner</option>
                      </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="box-footer">
                      <ul class="mailbox-attachments clearfix">
                        <li>
                          <span class="mailbox-attachment-icon has-img"><img src="{{ URL::to('images/profiles/'.$user->path) }}" alt="Attachment"/></span>
