                   ...
                   <tbody>
                    <?php $tmp = 0; ?>
                      ...
                      <tr> 
                        ...
                        <td>
                        <a href="{{ URL::To('admin/plant/show/'.$plant->id) }}">
                          {{ $plant->profile_name }} 
                        </a>
                      </td>
                        <td>
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/plant/delete/'.$plant->id) }}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           <a href="{{ URL::To('admin/plant/edit/'.$plant->id) }}">
