		...
		<div class="container">
				...
				<div class="col-md-6 info">
					<table class="table m-b-none">
						<tbody>
							...
							<tr>
								<td style="color: #9ACD32;">{{ $seed->name }}</td>
							</tr>

							<tr>
								<td>Harga Per Bibit</td>
							</tr>
							<tr>
							<td style="color: #9ACD32;">Rp.{{ $seed->price }}</td>
							</tr>
							...
							<tr>
								<td style="color: #9ACD32; font-size : 200%;">Rp. {{ $jumlah * $seed->price }}</td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div class="row feature text-center">
				...
				<div class="col-md-6">
					...
					<p style="color: #9ACD32;"><b>Format : [nama]_[jenis bibit]_[jumlah biaya]_[waktu transfer]</b></p><br>
