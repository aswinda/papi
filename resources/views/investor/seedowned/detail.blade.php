  		...
  		<div class="container">
    		...
    		<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
      			<ul class="nav navbar-nav">
        			...
        			<li class="dropdown">
        				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
	      				...
	      				<ul class="dropdown-menu">
		      				<li><a href="{{ URL::to('investor/seedowned') }}">Leeds</a></li>
        			...
        			<li class="dropdown">
        				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
	      					Seed <b class="caret"></b>
	      				</a>
	      				<ul class="dropdown-menu">
							<li><a href="#">Buy seed</a></li>
				        </ul>
        			</li>
        			<li class="dropdown">
        				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
	...
	<div id="blogpost-wrapper">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12">
					<div class="main-pic">
						<img src="{{ URL::to('images/seeds/'.$seed->path) }}" class="img-responsive" alt="blogpost" />
					</div>					
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-10 post">
					...
					<div class="content">
						<div class="wrapper m-t-xl m-b">
				          <div class="row m-b">
				            <div class="col-xs-6 text-right">
				              Amount          
				              	<div class="font-bold">
				              		<h4 style="color: #9ACD32;">{{ $seed->amount }}</h4>
				              	</div>              
				            </div>
				            <div class="col-xs-6">
				              Price
				              	<div class="font-bold">
				              		<h4 style="color: #9ACD32;">Rp.{{ $seed->price }}</h4>
				              	</div>
				            </div>
				          </div>
				        </div>
				        ...
				        <center>
				        	<p>Status</p>
				        	<h4 style="color: #9ACD32;">{{ $seed->status }}</h4>
				        </center>
						<p>
