						...
						<div style="margin-bottom : 20px;">
							...
							<div>
								<center>
									...
									<a href="{{ URL::to('investor/landowned/detail/'.$land->id ) }}" class="btn btn-success" style="width : 100%; max-width: 210px;  ">Detail</a>
								</center>
							</div>
			...
			<div class="col-md-12 pagination pagination-centered" style="margin-top : -35px;">
				<ul>
				  	...
				  	<?php for($i = 1; $i <= $page_count; $i++) { ?>
				  		<li class="<?php if($i == $page) echo "active"; ?>"><a href="{{ URL::to('investor/landowned/'.$i ) }}"><?php echo $i; ?></a></li>
				  	<?php } ?>
