@extends('landowner.base.template')
@section('content')
	...
	<div id="grid-first" style="margin-top : 0px;">
		<div class="container" style="margin-top : -50px;">
						...
						<div style="margin-bottom : 20px;">
							...
							<div>
								<center>
									...
									<a href="{{ URL::to('landowner/detail/'.$land->id ) }}" class="btn btn-success" style="width : 100%; max-width: 210px;  ">Details</a>
								</center>
							</div>
			...
			<div class="col-md-12 pagination pagination-centered" style="margin-top : -35px;">
				<ul>
				  	<li><a href="{{ URL::to('landowner/land/'.($page-1) ) }}">&laquo;</a></li>
				  	<?php for($i = 1; $i <= $page_count; $i++) { ?>
				  		<li class="<?php if($i == $page) echo "active"; ?>"><a href="{{ URL::to('landowner/land/'.$i ) }}"><?php echo $i; ?></a></li>
				  	<?php } ?>
				  	<li><a href="{{ URL::to('landowner/land/'.($page+1) ) }}">&raquo;</a></li>
				</ul>
			</div>
